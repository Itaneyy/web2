...
exports.criarNotasDeTeste = async function (req, res) {
  await notas.cria(
    ...
    "Reunião com Cliente",
    4,
    "Discutir requisitos do novo sistema e alinhar prazos de entrega.",
  );
  ...
  await notas.cria(
    ...
    "Lista de Compras",
    3,
    "Comprar arroz, feijão, café e produtos de limpeza.",
  );
  ...
  await notas.cria(
    ...
    "Ideia de Projeto",
    1,
    "Criar um aplicativo para organização de tarefas pessoais.",
  );
  ...
  await notas.cria(
    ...
    "Estudos",
    5,
    "Revisar conceitos de Node.js, Promises e async/await.",
  );
  ...
  await notas.cria(
    ...
    "Backup",
    2,
    "Realizar backup completo do banco de dados até sexta-feira.",
  );
  res.redirect("/");
};
