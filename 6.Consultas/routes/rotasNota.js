...
/* GET Tela de confirmação de exclusão */
router.get(
  "/confirmaExclusao/:chave_nota",controllerNota.confirmaExclusao_get);

/* POST Realiza a exclusão definitiva */
router.post("/deleta", controllerNota.deleta_post);

router.get("/criaNotasTeste",controllerNota.criarNotasDeTeste)
